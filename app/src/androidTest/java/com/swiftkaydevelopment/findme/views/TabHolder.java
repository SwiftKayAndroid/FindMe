...
public class TabHolder extends RelativeLayout {
    ...
    private void configureLinearLayout(){
        ...
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT,px);
    ...
    private void initializeScroller(){
        ...
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(scrollerWidth,px);
