...
/**
 * Created by BN611 on 4/27/2015.
 */
public class BasicInfo extends Activity {

    //gui elements
    TextView tvdate;        //holds users date of birth
    EditText etfirstname;   //holds users first name
    EditText etlastname;    //holds users last name
    TextView genderet;      //holds users gender. shows alertDialog when clicked to select gender
    Button btnnext;         //check for correct input in all fields. Sends user to Registration.java
